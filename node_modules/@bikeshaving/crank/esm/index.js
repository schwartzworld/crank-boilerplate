import { _ as __extends, a as __values, b as __spread, c as __generator, d as __awaiter, e as __read, f as __assign } from './_tslib-21ac4f0e.js';
import { Repeater, SlidingBuffer } from '@repeaterjs/repeater';
import { EventTarget } from 'event-target-shim';
import { i as isPromiseLike, P as Pledge } from './pledge-363d33da.js';
...
var Host = /** @class */ (function (_super) {
    ...
    renderer) {
        ...
        _this.updateChildren = chase(function updateChildren(children) {
            ...
            if (this.hostsByKey) {
                try {
                    for (var _c = __values(this.hostsByKey.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var host_1 = _d.value;
            ...
            for (var host = this.firstChild; host !== undefined; host = host.nextSibling) {
                if (typeof host.node === "string") {
                    ...
                    if (host.node === undefined) {
                        childNodes.push.apply(childNodes, __spread(host.childNodes));
                    }
                    else {
    ...
    Host.prototype.step = function (next) {
        ...
        if (isPromiseLike(iteration)) {
            ...
            return iteration.then(function (iteration) {
                var updateP = new Pledge(iteration.value).then(function (child) {
    ...
    Host.prototype.refresh = function () {
        ...
        if (this.unmounted) {
            ...
            try {
                for (var _b = __values(this.publications), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var pub = _c.value;
                    pub.push(this.props);
                }
            }
    ...
    Host.prototype.catch = function (reason) {
        ...
        if (this.iterator === undefined ||
            ...
            try {
                ...
                new Pledge(iteration).then(function (iteration) {
                    if (iteration.done) {
                        _this.done = true;
                    }
...
var Renderer = /** @class */ (function () {
    ...
    Renderer.prototype.extend = function (env) {
        ...
        try {
            for (var _b = __values(Object.entries(env)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = __read(_c.value, 2), tag = _d[0], value = _d[1];
                if (value != null) {
                    this.env[tag] = value;
                }
            }
    ...
    Renderer.prototype.render = function (child, root) {
        ...
        return new Pledge(p).then(function () { return host.ctx; });
    };
    return Renderer;
}());

export { Context, Copy, Default, Fragment, Portal, Renderer, Text, clearFrame, createElement, isComponentElement, isElement, isIntrinsicElement, isKeyedElement, setFrame };
