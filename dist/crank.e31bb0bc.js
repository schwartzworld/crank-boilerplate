...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/@bikeshaving/crank/esm/index-06d991e2.js":[function(require,module,exports) {
"use strict";
  ...
  ParentNode.prototype.updateChildren = function (children) {
      ...
      if (tag !== Copy) {
        ...
        if (host.tag === tag && !(host.internal && host.unmounted)) {
          ...
          if (update === undefined) {
            ...
            updates.push(update); // host is reassigned so we need to capture its current value in
            ...
            update.then(function () {
              ...
              } else if (host1_1.replacedBy.replacedBy === undefined && host1_1.replacedBy.clock < nextNode_1.clock) {
    ...
    if (updates === undefined) {
      ...
      var nextResult = new Promise(function (resolve) {
        return _this.onNextChildren = resolve;
      });
...
function (_super) {
  ...
  ComponentNode.prototype.step = function () {
    ...
    if (this.finished) {
      ...
      if (isIteratorOrAsyncIterator(value)) {
        ...
        var pending_1 = value.then(function () {
          return undefined;
        }); // void :(
    ...
    var previousValue = Pledge.resolve(this.previousResult).then(function () {
      return _this.value;
    }).execute();
    var iteration = new Pledge(function () {
      return _this.iterator.next(previousValue);
    }).catch(function (err) {
  ...
  ComponentNode.prototype.run = function () {
    ...
    if (this.inflightPending === undefined) {
      ...
      if (isPromiseLike(pending_3)) {
        this.inflightPending = pending_3.finally(function () {
  ...
  ComponentNode.prototype.unmount = function () {
    ...
    if (!this.finished) {
      this.finished = true; // TODO: maybe we should return the async iterator rather than
      // republishing props
...
function () {
  ...
  Renderer.prototype.render = function (child, root) {
    ...
    return Pledge.resolve(host.update(portal.props)).then(function () {
      return host.value;
    }).execute();
...
Object.defineProperty(exports, "Context", {
  enumerable: true,
  get: function () {
    return _index06d991e.a;
  }
});
Object.defineProperty(exports, "Copy", {
  enumerable: true,
  get: function () {
    return _index06d991e.C;
  }
});
Object.defineProperty(exports, "Default", {
  enumerable: true,
  get: function () {
    return _index06d991e.D;
  }
});
Object.defineProperty(exports, "Fragment", {
  enumerable: true,
  get: function () {
    return _index06d991e.F;
  }
});
Object.defineProperty(exports, "HostContext", {
  enumerable: true,
  get: function () {
    return _index06d991e.H;
  }
});
Object.defineProperty(exports, "Portal", {
  enumerable: true,
  get: function () {
    return _index06d991e.P;
  }
});
Object.defineProperty(exports, "Raw", {
  enumerable: true,
  get: function () {
    return _index06d991e.R;
  }
});
Object.defineProperty(exports, "Renderer", {
  enumerable: true,
  get: function () {
    return _index06d991e.b;
  }
});
Object.defineProperty(exports, "Text", {
  enumerable: true,
  get: function () {
    return _index06d991e.T;
  }
});
...
Object.defineProperty(exports, "isElement", {
  enumerable: true,
  get: function () {
    return _index06d991e.i;
  }
});

var _index06d991e = require("./index-06d991e2.js");
},{"./index-06d991e2.js":"node_modules/@bikeshaving/crank/esm/index-06d991e2.js"}],"node_modules/@bikeshaving/crank/esm/dom.js":[function(require,module,exports) {
"use strict";
...
function updateProps(el, props, newProps) {
  for (var name_1 in (0, _index06d991e.g)((0, _index06d991e.g)({}, props), newProps)) {
...
function updateChildren(el, children) {
  ...
  if (el.childNodes.length === 0) {
    ...
    try {
      for (var children_1 = (0, _index06d991e.f)(children), children_1_1 = children_1.next(); !children_1_1.done; children_1_1 = children_1.next()) {
  ...
  try {
    for (var children_2 = (0, _index06d991e.f)(children), children_2_1 = children_2.next(); !children_2_1.done; children_2_1 = children_2.next()) {
    ...
    return (0, _index06d991e._)(this, function (_e) {
      switch (_e.label) {
        ...
        case 1:
          ...
          _a = (0, _index06d991e.f)(this), _b = _a.next();
          _e.label = 2;
        ...
        case 2:
          ...
          , 5];
          _c = _b.value;
          nextChildren = _c.children, nextProps = (0, _index06d991e.e)(_c, ["children"]);
...
}, _a[_index06d991e.R] = function (_a) {
  var value = _a.value;
...
}, _a[_index06d991e.P] = function (_a) {
  var _b, _c, _d, newRoot, children, e_4_1;

  var e_4, _e;

  var root = _a.root;
  return (0, _index06d991e._)(this, function (_f) {
    switch (_f.label) {
      case 0:
        if (root == null) {
      ...
      case 2:
        ...
        _b = (0, _index06d991e.f)(this), _c = _b.next();
        _f.label = 3;
...
/** @class */
function (_super) {
  (0, _index06d991e.d)(DOMRenderer, _super);
...
},{"./index-06d991e2.js":"node_modules/@bikeshaving/crank/esm/index-06d991e2.js"}],"node_modules/@bikeshaving/crank/dom.js":[function(require,module,exports) {
"use strict";
